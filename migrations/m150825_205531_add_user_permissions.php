...
class m150825_205531_add_user_permissions extends Migration
{
    ...
    public function down()
    {
        ...
        $this->insert('auth_item', ['name' => '/admin/user/*']);
        $this->insert('auth_item', ['name' => '/admin/user/default/*']);
        $this->insert('auth_item', ['name' => '/admin/user/default/bulk-activate']);
        $this->insert('auth_item', ['name' => '/admin/user/default/bulk-deactivate']);
        $this->insert('auth_item', ['name' => '/admin/user/default/bulk-delete']);
        $this->insert('auth_item', ['name' => '/admin/user/default/change-password']);
        $this->insert('auth_item', ['name' => '/admin/user/default/create']);
        $this->insert('auth_item', ['name' => '/admin/user/default/delete']);
        $this->insert('auth_item', ['name' => '/admin/user/default/grid-page-size']);
        $this->insert('auth_item', ['name' => '/admin/user/default/grid-sort']);
        $this->insert('auth_item', ['name' => '/admin/user/default/index']);
        $this->insert('auth_item', ['name' => '/admin/user/default/toggle-attribute']);
        $this->insert('auth_item', ['name' => '/admin/user/default/update']);
        $this->insert('auth_item', ['name' => '/admin/user/default/view']);
        $this->insert('auth_item', ['name' => '/admin/user/permission-groups/*']);
        $this->insert('auth_item', ['name' => '/admin/user/permission-groups/bulk-activate']);
        $this->insert('auth_item', ['name' => '/admin/user/permission-groups/bulk-deactivate']);
        $this->insert('auth_item', ['name' => '/admin/user/permission-groups/bulk-delete']);
        $this->insert('auth_item', ['name' => '/admin/user/permission-groups/create']);
        $this->insert('auth_item', ['name' => '/admin/user/permission-groups/delete']);
        $this->insert('auth_item', ['name' => '/admin/user/permission-groups/grid-page-size']);
        $this->insert('auth_item', ['name' => '/admin/user/permission-groups/grid-sort']);
        $this->insert('auth_item', ['name' => '/admin/user/permission-groups/index']);
        $this->insert('auth_item', ['name' => '/admin/user/permission-groups/toggle-attribute']);
        $this->insert('auth_item', ['name' => '/admin/user/permission-groups/update']);
        $this->insert('auth_item', ['name' => '/admin/user/permission-groups/view']);
        $this->insert('auth_item', ['name' => '/admin/user/permission/*']);
        $this->insert('auth_item', ['name' => '/admin/user/permission/bulk-activate']);
        $this->insert('auth_item', ['name' => '/admin/user/permission/bulk-deactivate']);
        $this->insert('auth_item', ['name' => '/admin/user/permission/bulk-delete']);
        $this->insert('auth_item', ['name' => '/admin/user/permission/create']);
        $this->insert('auth_item', ['name' => '/admin/user/permission/delete']);
        $this->insert('auth_item', ['name' => '/admin/user/permission/grid-page-size']);
        $this->insert('auth_item', ['name' => '/admin/user/permission/grid-sort']);
        $this->insert('auth_item', ['name' => '/admin/user/permission/index']);
        $this->insert('auth_item', ['name' => '/admin/user/permission/refresh-routes']);
        $this->insert('auth_item', ['name' => '/admin/user/permission/set-child-permissions']);
        $this->insert('auth_item', ['name' => '/admin/user/permission/set-child-routes']);
        $this->insert('auth_item', ['name' => '/admin/user/permission/toggle-attribute']);
        $this->insert('auth_item', ['name' => '/admin/user/permission/update']);
        $this->insert('auth_item', ['name' => '/admin/user/permission/view']);
        $this->insert('auth_item', ['name' => '/admin/user/role/*']);
        $this->insert('auth_item', ['name' => '/admin/user/role/bulk-activate']);
        $this->insert('auth_item', ['name' => '/admin/user/role/bulk-deactivate']);
        $this->insert('auth_item', ['name' => '/admin/user/role/bulk-delete']);
        $this->insert('auth_item', ['name' => '/admin/user/role/create']);
        $this->insert('auth_item', ['name' => '/admin/user/role/delete']);
        $this->insert('auth_item', ['name' => '/admin/user/role/grid-page-size']);
        $this->insert('auth_item', ['name' => '/admin/user/role/grid-sort']);
        $this->insert('auth_item', ['name' => '/admin/user/role/index']);
        $this->insert('auth_item', ['name' => '/admin/user/role/set-child-permissions']);
        $this->insert('auth_item', ['name' => '/admin/user/role/set-child-roles']);
        $this->insert('auth_item', ['name' => '/admin/user/role/toggle-attribute']);
        $this->insert('auth_item', ['name' => '/admin/user/role/update']);
        $this->insert('auth_item', ['name' => '/admin/user/role/view']);
        $this->insert('auth_item', ['name' => '/admin/user/user-permission/*']);
        $this->insert('auth_item', ['name' => '/admin/user/user-permission/set']);
        $this->insert('auth_item', ['name' => '/admin/user/user-permission/set-roles']);
        $this->insert('auth_item', ['name' => '/admin/user/visit-log/*']);
        $this->insert('auth_item', ['name' => '/admin/user/visit-log/bulk-activate']);
        $this->insert('auth_item', ['name' => '/admin/user/visit-log/bulk-deactivate']);
        $this->insert('auth_item', ['name' => '/admin/user/visit-log/bulk-delete']);
        $this->insert('auth_item', ['name' => '/admin/user/visit-log/create']);
        $this->insert('auth_item', ['name' => '/admin/user/visit-log/delete']);
        $this->insert('auth_item', ['name' => '/admin/user/visit-log/grid-page-size']);
        $this->insert('auth_item', ['name' => '/admin/user/visit-log/grid-sort']);
        $this->insert('auth_item', ['name' => '/admin/user/visit-log/index']);
        $this->insert('auth_item', ['name' => '/admin/user/visit-log/toggle-attribute']);
        $this->insert('auth_item', ['name' => '/admin/user/visit-log/update']);
        $this->insert('auth_item', ['name' => '/admin/user/visit-log/view']);

        $this->insert('auth_item', ['name' => 'assignRolesToUsers']);
        $this->insert('auth_item', ['name' => 'bindUserToIp']);
        $this->insert('auth_item', ['name' => 'changeUserPassword']);
        $this->insert('auth_item', ['name' => 'createUsers']);
        $this->insert('auth_item', ['name' => 'deleteUsers']);
        $this->insert('auth_item', ['name' => 'editUserEmail']);
        $this->insert('auth_item', ['name' => 'editUsers']);
        $this->insert('auth_item', ['name' => 'manageRolesAndPermissions']);
        $this->insert('auth_item', ['name' => 'viewRegistrationIp']);
        $this->insert('auth_item', ['name' => 'viewRolesAndPermissions']);
        $this->insert('auth_item', ['name' => 'viewUserEmail']);
        $this->insert('auth_item', ['name' => 'viewUserRoles']);
        $this->insert('auth_item', ['name' => 'viewUsers']);
        $this->insert('auth_item', ['name' => 'viewVisitLog']);
